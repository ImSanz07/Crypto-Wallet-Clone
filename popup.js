...
// State variables
let providerURL = 'https://polygon-mainnet.g.alchemy.com/v2/JpbjCRZYGd7_dRFdTKQi9x7fBlUvJDPl';
...
function handler() {
    ...
    const testAccount = '0x8F2896Bd5575c2623cd4292436C32cc2121794F3';
    // Account 2 ka hai
...
function checkBalance() {
    ...
    provider.getBalance(address).then((balance) => {
        const balanceInEth = ethers.util.formatEther(balance);
...
function addAccount() {
    ...
    let wallet = new ether.Wallet(privateKey, provider);
